...
- **App content:** Practice tests, quizzes, tutorials, and workbook links
  ...
  user — the app does not require sign-in to use these features.
- **WhatsApp Chat:** Tapping the WhatsApp Chat button opens WhatsApp,
  which is governed by WhatsApp's own privacy policy, not ours.
- We do **not** use third-party advertising or analytics SDKs in this
  build. If you add any (e.g. Google AdMob, Firebase Analytics), update
  this section and complete the Play Console "Data Safety" form
  accordingly, and review Google Play's Families Policy requirements.

## Children's Privacy
This app is intended for use by school students, which may include
